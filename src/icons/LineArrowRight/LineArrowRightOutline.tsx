...
interface LineArrowRightOutlineProps {
  size?: number | string;
  color?: string;
}

const LineArrowRightOutline: React.FC<LineArrowRightOutlineProps> = ({ 
  size = 24, 
  color = "#1A1A1A" 
}) => {
  return (
