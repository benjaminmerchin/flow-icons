...
interface PersonFilledProps {
  size?: number | string;
  color?: string;
}

const PersonFilled: React.FC<PersonFilledProps> = ({ 
  size = 24, 
  color = "#1A1A1A" 
}) => {
  return (
...
<path d="M7.00005 6C7.00005 3.23858 9.23863 1 12 1C14.7615 1 17 3.23858 17 6C17 8.76142 14.7615 11 12 11C9.23863 11 7.00005 8.76142 7.00005 6Z" fill={color}/>
