...
interface SquareArrowUpOutlineProps {
  size?: number | string;
  color?: string;
}

const SquareArrowUpOutline: React.FC<SquareArrowUpOutlineProps> = ({ 
  size = 24, 
  color = "#1A1A1A" 
}) => {
  return (
...
<path d="M5 7.5H9V9.5H5C4.44772 9.5 4 9.94772 4 10.5V19.5C4 20.0523 4.44772 20.5 5 20.5H19C19.5523 20.5 20 20.0523 20 19.5V10.5C20 9.94772 19.5523 9.5 19 9.5H15V7.5H19C20.6569 7.5 22 8.84315 22 10.5V19.5C22 21.1569 20.6569 22.5 19 22.5H5C3.34315 22.5 2 21.1569 2 19.5V10.5C2 8.84315 3.34315 7.5 5 7.5Z" fill={color}/>
