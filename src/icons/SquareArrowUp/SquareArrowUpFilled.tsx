...
<path d="M5 7.5H9V14C9 15.6569 10.3431 17 12 17C13.6569 17 15 15.6569 15 14V7.5H19C20.6569 7.5 22 8.84315 22 10.5V19.5C22 21.1569 20.6569 22.5 19 22.5H5C3.34315 22.5 2 21.1569 2 19.5V10.5C2 8.84315 3.34315 7.5 5 7.5Z" fill="currentColor"/>
    </svg>
  );
}
