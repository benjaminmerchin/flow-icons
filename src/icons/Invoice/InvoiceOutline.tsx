...
interface InvoiceOutlineProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}
...
function InvoiceOutline({ 
  ...
  return (
    <svg 
      ...
      {...props}
    >
      <path d="M11 6C10.4477 6 10 6.44772 10 7C10 7.55228 10.4477 8 11 8H17C17.5523 8 18 7.55228 18 7C18 6.44772 17.5523 6 17 6H11Z" fill="currentColor"/>
<path d="M10 11C10 10.4477 10.4477 10 11 10H17C17.5523 10 18 10.4477 18 11C18 11.5523 17.5523 12 17 12H11C10.4477 12 10 11.5523 10 11Z" fill="currentColor"/>
