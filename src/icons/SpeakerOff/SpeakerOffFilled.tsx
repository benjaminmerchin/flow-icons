...
interface SpeakerOffFilledProps {
  size?: number | string;
  color?: string;
}

const SpeakerOffFilled: React.FC<SpeakerOffFilledProps> = ({ 
  size = 24, 
  color = "#1A1A1A" 
}) => {
  return (
