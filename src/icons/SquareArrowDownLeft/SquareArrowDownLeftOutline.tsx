...
interface SquareArrowDownLeftOutlineProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}
...
function SquareArrowDownLeftOutline({ 
  ...
  return (
    <svg 
      ...
      {...props}
    >
      <path d="M16.182 16C16.7343 16 17.182 15.5523 17.182 15C17.182 14.4477 16.7343 14 16.182 14H11.4142L18.7071 6.70711C19.0976 6.31658 19.0976 5.68342 18.7071 5.29289C18.3166 4.90237 17.6834 4.90237 17.2929 5.29289L10 12.5858V7.81799C10 7.2657 9.55232 6.81799 9.00003 6.81799C8.44775 6.81799 8.00003 7.2657 8.00003 7.81799V15C8.00003 15.5523 8.44775 16 9.00003 16H16.182Z" fill="currentColor"/>
