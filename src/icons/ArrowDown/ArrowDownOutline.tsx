...
interface ArrowDownOutlineProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

function ArrowDownOutline({ 
  size = 24,
  ...props
}: ArrowDownOutlineProps) {
  return (
    <svg 
      width={size} 
      height={size} 
