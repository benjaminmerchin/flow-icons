...
interface ArrowDownLeftFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

function ArrowDownLeftFilled({ 
  size = 24,
  ...props
}: ArrowDownLeftFilledProps) {
  return (
    <svg 
      width={size} 
      height={size} 
