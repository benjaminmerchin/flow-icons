...
interface PlayCircleOutlineProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}
...
function PlayCircleOutline({ 
  ...
  return (
    <svg 
      ...
      {...props}
    >
      <path fillRule="evenodd" clipRule="evenodd" d="M10.295 6.63012C9.29592 6.0057 8 6.72397 8 7.90212V16.0979C8 17.276 9.29592 17.9943 10.295 17.3699L16.8516 13.272C17.7916 12.6845 17.7916 11.3155 16.8516 10.728L10.295 6.63012ZM15.1132 12L10 15.1957V8.80424L15.1132 12Z" fill="currentColor"/>
