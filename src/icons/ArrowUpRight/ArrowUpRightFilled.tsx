...
interface ArrowUpRightFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

function ArrowUpRightFilled({ 
  size = 24,
  ...props
}: ArrowUpRightFilledProps) {
  return (
    <svg 
      width={size} 
      height={size} 
