...
interface SquareSquarePlusOutlineProps {
  size?: number | string;
  color?: string;
}

const SquareSquarePlusOutline: React.FC<SquareSquarePlusOutlineProps> = ({ 
  size = 24, 
  color = "#1A1A1A" 
}) => {
  return (
